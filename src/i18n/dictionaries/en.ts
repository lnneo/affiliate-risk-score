...
export const en: Dictionary = {
  ...
  ruleDescriptions: {
    SELF_REFERRAL: 'Affiliate email matches buyer email or account',
    SAME_PAYMENT_ACCOUNT: 'Buyer uses affiliate payment account',
    SAME_COOKIE: 'Buyer cookie matches affiliate creation session',
    SAME_FINGERPRINT: 'Buyer device fingerprint matches affiliate device',
    SAME_IP: 'Buyer IP address matches affiliate click IP',
    DISPOSABLE_EMAIL: 'Buyer uses disposable or temporary email domain',
    VPN_USAGE: 'Buyer or click IP detected as commercial VPN',
    PROXY_USAGE: 'Buyer or click IP detected as proxy',
    DATACENTER_IP: 'Traffic originates from a datacenter hosting provider',
    VELOCITY_EXCEEDED: 'High frequency of purchases or clicks in short timeframe',
    IP_BLACKLISTED: 'IP address is explicitly blacklisted in security database',
    REFERRER_SPAM_OR_CLOAKED: 'Referrer URL is blacklisted, cloaked, or suspicious',
    SUSPICIOUS_GEOLOCATION: 'Traffic originates from high-risk or non-target country',
    CLICK_INFLATION_NO_CONVERSION: 'High click volume from affiliate with abnormally low conversion rate',
    DUPLICATE_CONVERSION: 'Duplicate customer ID or transaction ID claiming multiple commissions',
  },
  refLanding: {
